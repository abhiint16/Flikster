...
public class AuctionCurrentFragmentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AuctionCurrentFragmentAdapter(Context context, FragmentManager fragmentManager) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder.getItemViewType() == 0) {
            ...
            auctionRelatedProductsViewHolder = new AuctionRelatedProductsViewHolder(context, fragmentManager);
