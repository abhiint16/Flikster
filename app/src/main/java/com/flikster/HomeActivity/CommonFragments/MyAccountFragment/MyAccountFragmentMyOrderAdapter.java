...
public class MyAccountFragmentMyOrderAdapter extends RecyclerView.Adapter<MyAccountFragmentMyOrderAdapter.ViewHolder> {
    @Override
    public MyAccountFragmentMyOrderAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
