...
public class CelebrityBioAdapterFamilyViewHolder extends RecyclerView.Adapter<CelebrityBioAdapterFamilyViewHolder.ViewHolder> {
    List<String> imag=new ArrayList<>();

    public CelebrityBioAdapterFamilyViewHolder() {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.card_celebrity_bio_family_recycler_item,parent,false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            //imageView=(ImageView)itemView.findViewById(R.id.card_celebrity_bio_family_recycler);
        }
    }
}
