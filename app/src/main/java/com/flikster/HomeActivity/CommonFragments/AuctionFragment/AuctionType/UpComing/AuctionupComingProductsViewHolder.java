...
public class AuctionupComingProductsViewHolder extends RecyclerView.Adapter<AuctionupComingProductsViewHolder.ViewHolder> {
    List<String> imag = new ArrayList<>();
    FragmentManager fragmentManager;
    int a;
    Context context;

    public AuctionupComingProductsViewHolder(Context context, FragmentManager fragmentManager) {
