...
//                feedAdapter = new FeedRecyclerAdapter(getActivity(), fragmentManager, items, Count, testing);
    ...
    public interface WatchFragCommInterface {
        void carouselContainerClick(String toolbarTitle,String url,Fragment fragment,String itemType);
        void carouselItemClick(String toolbarTitle,String img,String title,String audio,String type,Fragment fragment,String itemType);
        void carouselItemToMovie(String slug,Fragment fragment);
        void carouselItemToGallery(List<String> galleryImgLinks,String name,String profilePic,String type,String title,Fragment fragment,String cardId,String slug);
    }
