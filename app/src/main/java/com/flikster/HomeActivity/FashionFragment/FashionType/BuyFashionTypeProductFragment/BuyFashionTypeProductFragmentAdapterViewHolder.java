...
//        }else {
//            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_buy_product, parent, false);
//            return new BuyFashionTypeProductFragmentAdapterViewHolder.ViewHolder1(view);
//        }
...
//
//
//            ((BuyFashionTypeProductFragmentAdapter.ViewHolder2) holder).fragment_common_recyclerview_with_tv_title.setText("Recommended Products");
//            layoutManager = new LinearLayoutManager(context, LinearLayoutManager.HORIZONTAL, false);
//            ((BuyFashionTypeProductFragmentAdapter.ViewHolder2) holder).fragment_common_recyclerview_with_tv_recycler.setLayoutManager(layoutManager);
//            menFashionFragmentAdapterViewHolder = new BuyFashionTypeProductFragmentAdapter(fragmentManager);
//            ((BuyFashionTypeProductFragmentAdapter.ViewHolder2) holder).fragment_common_recyclerview_with_tv_recycler.setAdapter(menFashionFragmentAdapterViewHolder);
//        }
